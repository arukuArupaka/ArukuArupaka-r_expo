    ...
    sendMessage: (messageObject) => {
      ...
      setDisplayMessageArray((prevMessages) => {
        ...
        return uniqueArray.sort(
            (a, b) => new Date(sortSitingTime(a.sendAt)) - new Date(sortSitingTime(b.sendAt))
        );
    });
    ...
    const refreshChatMessages = async () => {
      ...
      for (let i = 0; i < retryCount; i++) {
        console.log(props.roomID)
          storedMessages = await AsyncStorage.getItem(`chatMessages_${props.roomID}`);
      ...
      if (displayMessageArray.length === 0) {
        ...
        setDisplayMessageArray((prev) => {
          ...
          const combinedArray = [...prev, ...parsedStoredMessages, ...unreadMessagesJSONconcatArray];
        ...
        setDisplayMessageArray((prevMessages) => {
          ...
          const combinedArray = [...prevMessages, ...unreadMessagesJSONconcatArray];
