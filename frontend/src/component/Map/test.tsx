...
"https://db-manager-api.arupaka.uk/lecture/get-occupied-classrooms?campus=BKC&schoolYear=2025&semester=Spring&weekday=Monday&period=1"
  ...
  const fetchOccupiedClassrooms = async (weekday) => {
    ...
    setError(null);
    try {
      const response = await fetch(`https://db-manager-api.arupaka.uk/lecture/get-occupied-classrooms?campus=BKC&schoolYear=2025&semester=Spring&weekday=${weekday}&period=1`);
      if (!response.ok) {
