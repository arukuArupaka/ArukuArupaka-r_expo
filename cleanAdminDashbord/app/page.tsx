...
import NotificationsPage from "@/components/notificaations";
...
export default function AdminDashboard() {
  ...
  const handleNotificationView = () => setCurrentView("notification");
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="flex">
        ...
        <main className="flex-1 p-6">
          ...
          {currentView === "notification" && <NotificationsPage />}
        </main>
      </div>
    </div>
  );
